# -*- coding: utf-8 -*-
"""Chest_xrayFinal.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1mt3NeYHiWTutgMLqEzl6wwmGYInI4Y1e
"""
...
plt.subplot(1,3,1)
sns.countplot(data=train_df, x='Diagnos')
plt.title('Train data')

plt.subplot(1,3,2)
sns.countplot(data=test_df, x='Diagnos')
plt.title('Test data')

plt.subplot(1,3,3)
sns.countplot(data=val_df, x='Diagnos')
...
model.save('/content/drive/My Drive/my_model.h5')  # Save the model to Google Drive
...
predict('/content/drive/My Drive/Chest_xray2/test/PNEUMONIA/person19_virus_50.jpeg')

# japanese_macaque
# !wget -q https://hongkongliving.com/wp-content/uploads/2019/06/Monkey-Hill.jpg
predict('/content/drive/My Drive/Chest_xray2/val/NORMAL/NORMAL2-IM-1437-0001.jpeg')

# patas_monkey
# !wget -q https://sambadenglish.com/wp-content/uploads/2019/05/Nilgiri-langur-1024x683.jpg
predict('/content/drive/My Drive/Chest_xray2/val/PNEUMONIA/person1954_bacteria_4886.jpeg')
